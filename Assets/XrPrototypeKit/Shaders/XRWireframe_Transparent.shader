...
// Adapted from "VR/SpatialMapping/Wireframe" (single color instead of distance color)

Shader "PrototypeKit/XRWireframe_Transparent"
{
    Properties
    {
        _WireThickness ("Wire Thickness", RANGE(0, 800)) = 100
		_WireColor ("Wire Color", Color) = (0.0, 1.0, 1.0, 1.0) // cyan
    }
